...
docs/               adr/, architecture/, project-division/   # 决策记录/架构设计/任务清单
...
| `src/application/` | 用例编排(只依赖 domain + shared) | ✅ A3 |
| `src/infrastructure/` | OpenAI/队列/仓储/文件系统实现(适配器) | ✅ A2–A3;weather 待 B4 |
...
| `docs/` | ADR / 架构设计 / 任务清单 | ✅;runbooks 待 C7、records 待 C8 |
